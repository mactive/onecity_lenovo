...
elseif ($_REQUEST['act'] == 'insert')
{
	...
	/*处理图片*/    
    $img_name = basename($image->upload_image($_FILES['cat_logo'],'articlelogo'));

    $sql = "INSERT INTO ".$ecs->table('article_cat')."(cat_name, cat_type, cat_desc,keywords, templete , parent_id, sort_order, show_in_nav,cat_logo,cat_article_id,cat_user_rank)
           VALUES ('$_POST[cat_name]', '$cat_type',  '$_POST[cat_desc]','$_POST[keywords]', '$_POST[templete]', '$_POST[parent_id]', '$_POST[sort_order]', '$_POST[show_in_nav]','$img_name','$_POST[cat_article_id]','$_POST[cat_user_rank]')";
    $db->query($sql);
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $sql = "SELECT cat_id, cat_name, cat_type, cat_desc, show_in_nav, keywords, templete,sort_order, parent_id,cat_article_id,cat_logo,cat_user_rank FROM ".
...
elseif ($_REQUEST['act'] == 'update')
{
	...
	$param = " cat_name = '$_POST[cat_name]', cat_desc ='$_POST[cat_desc]', keywords='$_POST[keywords]', templete='$_POST[templete]',  parent_id = '$_POST[parent_id]', cat_type='$cat_type', sort_order='$_POST[sort_order]', show_in_nav = '$_POST[show_in_nav]', cat_article_id = '$_POST[cat_article_id]',cat_user_rank = '$_POST[cat_user_rank]' ";
