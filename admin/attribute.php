...
/**
 * SINEMALL 属性规格管理    $Author: testyang $
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $cat_id = $_REQUEST['cat_id'];
	 ...
	 /*处理图片*/
    $img_name = basename($image->upload_image($_FILES['attr_img'],"attrimg"));
	$img_na = $_FILES['attr_img']['name'];
    ...
    $attr = array(
		...
		'attr_brief'     => isset($_POST['attr_brief']) ? $_POST['attr_brief'] : '',
		'attr_desc'     => isset($_POST['attr_desc']) ? $_POST['attr_desc'] : '',
