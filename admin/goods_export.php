...
/**
 * SINEMALL*=======================================* @author:     wj                 <wjzhangq@126.com>
 * @version:    v2.x
 * ---------------------------------------------
 * $Author: testyang $
 * $Id: goods_export.php 14762 2008-07-29 01:20:48Z testyang $
*/
...
elseif ($_REQUEST['act'] == 'act_export_taobao')
{
    ...
    while ($row = $db->fetchRow($res))
    {
        ...
        $goods_value['goods_desc'] = str_replace("\r\n", "", image_path_format($row['goods_desc']));
        $goods_value['goods_desc'] = str_replace("\t", "    ", $goods_value['goods_desc']);
...
elseif ($_REQUEST['act'] == 'act_export_paipai')
{
    ...
    while ($row = $db->fetchRow($res))
    {
        ...
        $goods_value['description'] = str_replace("\r\n", "", image_path_format($row['goods_desc']));
        $goods_value['description'] = str_replace("\t", "    ", $goods_value['description']);
        $goods_value['description'] = str_replace("\n", "", $goods_value['description']);
        $goods_value['description'] = '"' . str_replace('"', '""', $goods_value['description']) . '"';
