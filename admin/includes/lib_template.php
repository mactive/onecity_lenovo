...
/**
 * SINEMALL 管理中心模版相关公用函数库    $Author: zhuwenyuan $
...
$page_libs = array(
    'article' => array(
		...
		'/library/quick_link.lbi' => 0,
		'/library/news_index.lbi' => 0,
		'/library/ads_fat.lbi' => 0,
		'/library/ads_thin.lbi' => 0,		
        '/library/member.lbi' => 0,
        '/library/customer_center.lbi' => 0,
    ...
    'category_list' => array(
        '/library/ur_here.lbi' => 0,
        '/library/search_form.lbi' => 0,
        '/library/category_tree_fat.lbi' => 0,
		'/library/quick_link.lbi' => 0,
		'/library/news_index.lbi' => 0,
		'/library/ads_fat.lbi' => 0,
		'/library/ads_thin.lbi' => 0,		
    ...
    'category' => array(
        ...
        '/library/cart.lbi' => 0,
        '/library/vote.lbi' => 0,
		'/library/sub_cate_list.lbi' => 0,
        '/library/price_grade.lbi' => 0,
        '/library/filter_attr.lbi' => 0,
    ),
	'category_no_goods' => array(
        '/library/ur_here.lbi' => 0,
        '/library/search_form.lbi' => 0,
        '/library/member.lbi' => 0,
		'/library/quick_link.lbi' => 0,
    ...
    'index' => array(
        ...
        '/library/category_tree.lbi' => 0,
        '/library/index_recommend_best.lbi' => 12,
        '/library/recommend_new.lbi' => 3,
        '/library/recommend_hot_index.lbi' => 3,
        '/library/recommend_promotion.lbi' => 3,
        '/library/recommend_ajax.lbi' => 0,
        '/library/brands.lbi' => 0,
        '/library/promotion_info.lbi' => 0,
		'/library/help_bar.lbi' => 0,
		'/library/buy_guide.lbi' => 0,
		'/library/quick_link.lbi' => 0,
		'/library/news_index.lbi' => 0,
		'/library/ads_fat.lbi' => 0,
		'/library/ads_thin.lbi' => 0,		
		'/library/contact_bar.lbi' => 0,
...
function get_template_info($template_name)
{
    ...
    if (file_exists('../themes/' . $template_name . '/css.css') && !empty($template_name))
    {
        $arr = array_slice(file('../themes/'. $template_name. '/css.css'), 0, 9);
