<?php
/**
 * SINEMALL 控制台首页    $Author: testyang $
...
elseif ($_REQUEST['act'] == 'menu')
{
    ...
    $purview['01_inventory_list']       = 'inventory_list';
    $purview['02_inspect_part_number']  = 'inspect_part_number';
    $purview['03_batch_inventory']        = 'batch_inventory';
    $purview['04_out_of_date_inventory']= 'out_of_date_inventory';
    $purview['05_inventory_status']     = 'inventory_status';
    $purview['06_inventory_log']        = 'inventory_log';
    $purview['07_inventory_status_accounting'] = 'inventory_status_accounting';
...
elseif ($_REQUEST['act'] == 'main')
{
	...
	*/
    ...
    {
        $smarty->assign('need_check_version', 0);
    }
