...
function SelectZone()
{
  ...
  this.addItem = function(all, act)
  {
    ...
    if (selOpt.length > 0)
    {
      ...
      Ajax.call(this.filename + "&act="+act+"&add_ids=" +obj2str(selOpt), args, this.addRemoveItemResponse, "GET", "JSON");
    }
  }
  ...
  this.dropItem = function(all, act)
  {
    ...
    if (arr.length > 0)
    {
      ...
      Ajax.call(this.filename + "&act="+act+"&drop_ids=" + obj2str(arr), args, this.addRemoveItemResponse, 'GET', 'JSON');
    }
  }
