...
/**
 * SINEMALL 客户留言    $Author: testyang $
 * $Id: user_msg.php 14481 2008-04-18 11:23:01Z testyang $
*/
...
function msg_list()
{
    ...
    $sql = "SELECT f.msg_id, f.user_name,f.user_email, f.msg_title, f.msg_type, f.msg_time, COUNT(r.msg_id) AS reply " .
