          ...
          <td align="center" valign="top" background="../../images/3.gif"><!-- InstanceBeginEditable name="Text" --> 
            <table width="100%" height="192" border="0" align="center" cellpadding="0" cellspacing="0"> 
              ...
              <tr> 
                ...
                <td align="center" valign="top" bgcolor="#FFFFFF"> <p><font color="#9c00ce"><a href="../../AATC/event_add.php">课程添加<font color="#FF0000">&nbsp;</font></a><font color="#FF0000">&nbsp;&nbsp;<a href="event_show.php">课程管理</a>&nbsp;</font></font></p> 
                  <?php
...
?> 
                  <form name="form2" method="post" action="<? echo $PHP_SELF?>"  style="MARGIN: 0px"> 
                    <table width="100%" border="0" class="thin"  bordercolorlight="#CEEFFF" cellpadding="1" cellspacing="1"> 
                      <tr> 
					  <th width="8%" height="22" nowrap> 编号</th>
                        <th width="9%" height="22" nowrap> 年</th> 
                        <th width="10%" nowrap> 月</th> 
                        <th width="8%" nowrap> 日</th> 
                        <th width="14%" nowrap> 时间 </th> 
                        <th width="33%" nowrap> 主题</th> 
                        <th width="7%" nowrap> 修改</th> 
                        <th width="11%" nowrap> 删除</th> 
                      </tr> 
                      <?php
		while($arr=$db->fetch()){
			//设置 id ,title
	?> 
                      <tr> 
                        ...
                        <td width="7%" align="center"><a href="update_event.php?event_id=<?=$arr['event_id']?>" target=_blank  title="修改"><img src="../images/b_edit.png" width="15" height="15" border="0"></a></td> 
                        <td width="11%" align="center"><a href="event_delete.php?event_id=<?=$arr['event_id']?>" onClick="delcfm()"  title="删除"><img src="../images/b_drop.png" width="16" height="16" border="0"></a></td> 
                      </tr> 
<?php }?> 
                      <tr> 
