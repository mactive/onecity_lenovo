...
?> 
                  <form name="form2" method="post" action="<? echo $PHP_SELF?>"  style="MARGIN: 0px"> 
                    <table width="100%" border="0" class="thin"  bordercolorlight="#CEEFFF" cellpadding="1" cellspacing="1"> 
                      <tr> 
                        ...
                        <th width="20%" nowrap> 联系人</th> 
                        <th width="18%" nowrap> 固定电话 </th> 
                        <th width="23%" nowrap> 移动电话</th> 
	...
	?> 
                      <tr> 
                        ...
                        <td width="11%"><a href="show_gronews.php?comid=<?=$arr['comid']?>" target=_blank><?=$arr['comname']?></a></td> 
                        <td width="20%" align="center"> <?php echo $arr['ename']?></td> 
                        <td width="18%" align="center" bgcolor="#CCCCCC"> <?php echo $arr['telephone']?></td> 
                        <td width="23%" align="center" bgcolor="#CCCCCC">  <?php echo $arr['phone']?> </td> 
                        <td width="9%" align="center"><a href="update_gro.php?comid=<?=$arr['comid']?>" target=_blank  title="修改"><img src="../images/b_edit.png" width="16" height="16" border="0"></a></td> 
                        <td width="9%" align="center"><a href="delete_gro.php?comid=<?=$arr['comid']?>" onClick="delcfm()"  title="删除"><img src="../images/b_drop.png" width="16" height="16" border="0"></a></td> 
                      </tr> 
<?php }?> 
                      <tr> 
