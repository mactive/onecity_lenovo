          ...
          <td align="center" valign="top" background="../../images/3.gif"><!-- InstanceBeginEditable name="Text" --> 
            <table width="100%" height="192" border="0" align="center" cellpadding="0" cellspacing="0"> 
              ...
              <tr> 
                ...
                <td align="center" valign="top" bgcolor="#FFFFFF"> <p><font color="#9c00ce"><a href="registration.php">个人报名管理 </a><font color="#FF0000">&nbsp;&nbsp;&nbsp;&nbsp;</font></font><span class="style1"><a href="group.php">团体报名管理</a></span><font color="#9c00ce"><a href="registration.php"> </a><font color="#FF0000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="course.php">课程管理</a>&nbsp;</font></font></p> 
                  <?php
...
?> 
                  <form name="form2" method="post" action="<? echo $PHP_SELF?>"  style="MARGIN: 0px"> 
                    <table width="100%" border="0" class="thin"  bordercolorlight="#CEEFFF" cellpadding="1" cellspacing="1"> 
                      <tr> 
                        ...
                        <th width="11%" nowrap> 姓名</th> 
                        <th width="20%" nowrap> 公司</th> 
                        <th width="18%" nowrap> 所选班次 </th> 
                        <th width="23%" nowrap> 联系电话</th> 
	...
	?> 
                      <tr> 
                        <td width="10%" height="20"><?=$arr['comid']?></td> 
                        <td width="11%"><a href="show_regnews.php?comid=<?=$arr['comid']?>" target=_blank><?=$arr['name']?></a></td> 
                        <td width="20%" align="center"> <?php echo $arr['comname']?></td> 
                        <td width="18%" align="center" bgcolor="#CCCCCC"> <?php echo $arr['classes']?></td> 
                        <td width="23%" align="center" bgcolor="#CCCCCC">  <?php echo $arr['telephone']?> </td> 
                        <td width="9%" align="center"><a href="update_reg.php?comid=<?=$arr['comid']?>" target=_blank  title="修改"><img src="../images/b_edit.png" width="15" height="15" border="0"></a></td> 
                        <td width="9%" align="center"><a href="delete_reg.php?comid=<?=$arr['comid']?>" onClick="delcfm()"  title="删除"><img src="../images/b_drop.png" width="16" height="16" border="0"></a></td> 
                      </tr> 
<?php }?> 
                      <tr> 
