...
if($_REQUEST['act'] == 'new_querenlv')
{
	...
	foreach($base AS $key => $value){
		...
		$sql_4_plus = "SELECT count(*) FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city'). " AS c " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = c.ad_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS cat ON cat.cat_id = c.city_id ". 
				" WHERE c.col_1 LIKE '$value[col_1]' AND cat.market_level = 4  ". // 
				" AND ad.audit_status = 5 AND ad.is_audit_confirm = 1 ".
				" AND cat.has_new = 1 AND ad.is_new = 1 GROUP BY c.city_id ";
				
			 // echo $sql_6."<br>";
			  // echo $sql_6_plus."<br>";
		$base[$key]['lv_4']['confirm_amount'] = $GLOBALS['db']->getOne($sql_4_plus);
		
		$sql_5_plus = "SELECT c.city_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city'). " AS c " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = c.ad_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS cat ON cat.cat_id = c.city_id ". 
			 ...
			 // echo $sql_6."<br>";
			  // echo $sql_6_plus."<br>";
		$base[$key]['lv_5']['confirm_amount'] = count($GLOBALS['db']->getAll($sql_5_plus));
		
		
		$sql_6_plus = "SELECT c.city_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city'). " AS c " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = c.ad_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS cat ON cat.cat_id = c.city_id ". 
		...
		// if ($cat_id == 9) {echo $sql_6."<br>";echo $sql_6_plus."<br>";}
		
		$base[$key]['lv_6']['confirm_amount'] = count($GLOBALS['db']->getAll($sql_6_plus));
		
		$sql_7_plus = "SELECT c.city_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city'). " AS c " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = c.ad_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS cat ON cat.cat_id = c.city_id ". 
			 ...
			 // echo $sql_6."<br>";
			  // echo $sql_6_plus."<br>";
		$base[$key]['lv_7']['confirm_amount'] = count($GLOBALS['db']->getAll($sql_7_plus));
...
elseif($_REQUEST['act'] == 'querenlv')
{
	...
	foreach($base AS $key => $value){
		...
		$sql_4 = "SELECT count(*) FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'category'). " AS a " .
		...
		$sql_5 = "SELECT count(*) FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'category'). " AS a " .
				" WHERE $children  AND a.market_level = 5 ".
				" AND a.cat_id <= ". NEWCITYAFTERID ; //
				
		//echo $sql_5;
		$sql_5_plus = "SELECT count(*) FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city'). " AS c " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = c.ad_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS cat ON cat.cat_id = c.city_id ". 
		...
		$sql_6 = "SELECT count(*) FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'category'). " AS a " .
		...
		$sql_6_plus = "SELECT c.city_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city'). " AS c " .
			...
			// if($cat_id == 19){echo $sql_6."<br>";echo $sql_6_plus."<br>";}
		...
		$sql_7 = "SELECT count(*) FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'category'). " AS a " .
				" WHERE $children  AND a.market_level LIKE'百强镇'".
				" AND a.cat_id <= ". NEWCITYAFTERID ; //
				
		
		$sql_7_plus = "SELECT count(*) FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city'). " AS c " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = c.ad_id ". 
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS cat ON cat.cat_id = c.city_id ". 
				" WHERE c.col_1 LIKE '$value[col_1]'  AND cat.market_level LIKE '百强镇'".
				" AND ad.audit_status = 5 AND ad.is_audit_confirm = 1 ".
...
elseif($_REQUEST['act'] == 'project_querenlv')
{
	...
	foreach($base AS $key => $value){
		...
		$sql_4_upload = "SELECT g.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_gallery'). " AS g " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = g.ad_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
		...
		$sql_4_plus = "SELECT au.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad_audit'). " AS au " .
		...
		//echo $sql_5;
		$sql_5_upload = "SELECT g.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_gallery'). " AS g " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = g.ad_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
		...
		$sql_5_plus = "SELECT au.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad_audit'). " AS au " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = au.ad_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
		...
		$sql_6_upload = "SELECT g.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_gallery'). " AS g " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = g.ad_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
				" WHERE $children AND g.feedback = '$project_id' AND a.market_level LIKE'%6%'  ".
				" AND a.cat_id <= " .NEWCITYAFTERID ." AND ad.is_new = 0 ".
				" GROUP BY g.ad_id ";
		// if($cat_id == 19){echo $value['col_1'].$sql_6_upload."<br>";}

		$sql_6_plus = "SELECT au.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad_audit'). " AS au " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = au.ad_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
				" WHERE $children AND au.feedback_audit = '$project_id' AND au.audit_note = '审核通过' AND au.user_rank = 2 AND a.market_level LIKE'%6%' ".
				" AND a.cat_id <= " .NEWCITYAFTERID ." AND ad.is_new = 0 ".
				" GROUP BY au.ad_id ";
		// if($cat_id == 19){echo $sql_6_plus."<br>";}
		...
		$sql_7_upload = "SELECT g.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_gallery'). " AS g " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = g.ad_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
		...
		$sql_7_plus = "SELECT au.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad_audit'). " AS au " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = au.ad_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
...
elseif($_REQUEST['act'] == 'base_info_querenlv')
{
	...
	foreach($base AS $key => $value){
		...
		$sql_4_upload = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
		...
		$sql_4_plus_2 = "SELECT au.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad_audit'). " AS au " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = au.ad_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
				...
				// " GROUP BY au.ad_id ";
		//
		$sql_4_plus_3 = "SELECT ma.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
		 		" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
				...
				" GROUP BY ad.ad_id ";
		//
		$sql_4_plus_4 = "SELECT ma.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
	 			" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_material') . " AS ma ON ma.ad_id = ad.ad_id ".
		...
		$sql_5_upload = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
 				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
		...
		$sql_5_plus_2 = "SELECT au.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad_audit'). " AS au " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = au.ad_id ". 
	 			" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
				...
				// " GROUP BY au.ad_id ";
		//
		$sql_5_plus_3 = "SELECT ma.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
 			" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_material') . " AS ma ON ma.ad_id = ad.ad_id ".
				...
				" GROUP BY ad.ad_id ";
		//
		$sql_5_plus_4 = "SELECT ma.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
 				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_material') . " AS ma ON ma.ad_id = ad.ad_id ".
		...
		$sql_6_upload = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
 				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
		...
		$sql_6_plus_2 = "SELECT au.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad_audit'). " AS au " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = au.ad_id ". 
	 			" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
		...
		$sql_6_plus_3 = "SELECT ma.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
 			" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_material') . " AS ma ON ma.ad_id = ad.ad_id ".
				...
				" GROUP BY ad.ad_id ";
		//
		$sql_6_plus_4 = "SELECT ma.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
 			" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_material') . " AS ma ON ma.ad_id = ad.ad_id ".
		...
		//
		$sql_7_upload = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
 			" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
		...
		$sql_7_plus = "SELECT au.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad_audit'). " AS au " .
				...
				" GROUP BY au.ad_id ";
		//echo $sql_5_plus."<br>";
		$sql_7_plus_2 = "SELECT au.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad_audit'). " AS au " .
				" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad') . " AS ad ON ad.ad_id = au.ad_id ". 
	 			" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
				...
				// " GROUP BY au.ad_id ";
		//
		$sql_7_plus_3 = "SELECT ma.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
 			" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_material') . " AS ma ON ma.ad_id = ad.ad_id ".
				...
				" GROUP BY ad.ad_id ";
		//
		$sql_7_plus_4 = "SELECT ma.ad_id FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
 			" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'category') . " AS a ON a.cat_id = ad.city_id ". 
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_material') . " AS ma ON ma.ad_id = ad.ad_id ".
...
elseif($_REQUEST['act'] == 'new_base_info_querenlv')
{
	...
	foreach($base AS $key => $value){
		...
		/*6级城市*/
		$sql_6 = "SELECT count(*) FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource'). " AS a " .
				" WHERE $children  AND a.market_level LIKE'%6%' "; //
		
		$sql_6_upload = "SELECT count(ad.ad_id) AS num,a.market_level AS  market_level  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
...
elseif($_REQUEST['act'] == 'audit_status_summary')
{
	...
	foreach($base AS $key => $value){
		...
		/*4级城市*/		
		$sql_4 = "SELECT count(*) FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource'). " AS a " .
				" WHERE $children  AND a.market_level = 4 ";
		//echo $sql_4;
		...
		//
		$sql_4_plus_1 = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource') . " AS a ON a.city_id = ad.city_id ". 
				" WHERE $children AND ad.is_upload = 1 AND ad.audit_status = 1 AND ad.is_audit_confirm = 0 AND a.market_level = 4 ".
				" GROUP BY ad.ad_id ";
		//
		$sql_4_plus_2 = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource') . " AS a ON a.city_id = ad.city_id ". 
				" WHERE $children AND ad.is_upload = 1 AND ad.audit_status = 5 AND ad.is_audit_confirm = 1 AND a.market_level = 4 ".
				" GROUP BY ad.ad_id ";
				
		$sql_4_plus_3 = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource') . " AS a ON a.city_id = ad.city_id ". 
...
//
/*5级城市*/		
		$sql_5 = "SELECT count(*) FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource'). " AS a " .
				" WHERE $children  AND a.market_level = 5 ";
		//echo $sql_5;
		...
		//
		$sql_5_plus_1 = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource') . " AS a ON a.city_id = ad.city_id ". 
				" WHERE $children AND ad.is_upload = 1 AND ad.audit_status = 1 AND ad.is_audit_confirm = 0 AND a.market_level = 5 ".
				" GROUP BY ad.ad_id ";
		//
		$sql_5_plus_2 = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource') . " AS a ON a.city_id = ad.city_id ". 
				" WHERE $children AND ad.is_upload = 1 AND ad.audit_status = 5 AND ad.is_audit_confirm = 1 AND a.market_level = 5 ".
				" GROUP BY ad.ad_id ";

		$sql_5_plus_3 = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource') . " AS a ON a.city_id = ad.city_id ". 
		...
		//
		$sql_6_plus_1 = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource') . " AS a ON a.city_id = ad.city_id ". 
				" WHERE $children AND ad.is_upload = 1 AND ad.audit_status = 1 AND ad.is_audit_confirm = 0 AND a.market_level LIKE'%6%'  ".
				" GROUP BY ad.ad_id ";
		//
		$sql_6_plus_2 = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource') . " AS a ON a.city_id = ad.city_id ". 
				" WHERE $children AND ad.is_upload = 1 AND ad.audit_status = 5 AND ad.is_audit_confirm = 1 AND a.market_level LIKE'%6%'  ".
				" GROUP BY ad.ad_id ";
				
		$sql_6_plus_3 = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource') . " AS a ON a.city_id = ad.city_id ". 
	...
	//
	/*7级城市*/		
		$sql_7 = "SELECT count(*) FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource'). " AS a " .
		...
		//
		$sql_7_plus_1 = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource') . " AS a ON a.city_id = ad.city_id ". 
				" WHERE $children AND ad.is_upload = 1 AND ad.audit_status = 1 AND ad.is_audit_confirm = 0 AND a.market_level LIKE'%百强镇%'  ".
				" GROUP BY ad.ad_id ";
		//
		$sql_7_plus_2 = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource') . " AS a ON a.city_id = ad.city_id ". 
				" WHERE $children AND ad.is_upload = 1 AND ad.audit_status = 5 AND ad.is_audit_confirm = 1 AND a.market_level LIKE'%百强镇%'  ".
				" GROUP BY ad.ad_id ";
				
		$sql_7_plus_3 = "SELECT ad.ad_id  FROM ".$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_ad'). " AS ad " .
			 	" LEFT JOIN " .$GLOBALS['ecs']->table($GLOBALS['year']."_".'city_resource') . " AS a ON a.city_id = ad.city_id ". 
