...
elseif ($_REQUEST['step'] == 'checkout')
{
    ...
    foreach ($shipping_list AS $key => $val)
    {
        ...
        $shipping_list[$key]['free_money_formated'] = price_format($shipping_cfg['free_money'], false);
...
elseif ($_REQUEST['step'] == 'done')
{
    ...
    {
        $shipping = shipping_info($order['shipping_id']);
		if($shipping['shipping_code'] == 'city_express'){
			$order['shipping_name'] = addslashes($_POST['custom_assign_shipping']); //如果不确定则从用户出取得
		}else{
