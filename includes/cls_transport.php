...
/**
 * SINEMALL 服务器之间数据传输器。采集到的信息包括HTTP头和HTTP体，
 * 并以一维数组的形式返回，如：array('header' => 'bar', 'body' => 'foo')。 * $Author: testyang $
 * $Id: cls_transport.php 14481 2008-04-18 11:23:01Z testyang $
 */
