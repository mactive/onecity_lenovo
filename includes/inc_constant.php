...
/* 会员级别 */
define('rank_webuser',       	1); // 网站用户
define('rank_preclient',       	2); // 潜在用户
define('rank_client',       	3); // 正式客户
define('rank_agency',       	4); // 机构用户
define('rank_vip',		     	5); // VIP员工

define('rank_sale_staff',       11); // 销售员工
define('rank_tech_staff',       12); // 技术员工
define('rank_finance_staff',    13); // 财务员工
define('rank_purchase_staff',   14); // 采购员工
define('rank_sine_company',     15); // 赛因公司
...
define('ERR_OUT_OF_PRICE',          7); // 商品价格有误
...
define('CS_AWAIT_PREPARE',          103); // 待发货：货到付款且未发货，非货到付款且已付款且未发货
...
define('sine_salesman',             '销售员工'); // 业务员
define('sine_client',               '客户'); // 客户
/*价格比例*/
define('shop_price_rate',			0);//执行商店价格比例
define('cat_price_rate',			1);//执行分类价格比例 去掉分类的价格显示比例
define('brand_price_rate',			2);//执行品牌价格比例
//define('M_COMPLAINT',               1); // 投诉
//define('M_ENQUIRY',                 2); // 询问
//define('M_CUSTOME',                 3); // 售后
...
/*金币数值*/
define('GOLD_1',             		1); //添加商品评论
define('GOLD_2',             		2); //添加商品评论
define('GOLD_5',             		5); //添加商品评论
define('GOLD_10',             		10); //添加商品评论
define('GOLD_30',             		30); //添加商品评论
define('GOLD_50',             		50); //添加商品评论
