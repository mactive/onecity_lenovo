...
/**
 * SINEMALL 用户相关函数库 * $Author: testyang $
 * $Id: lib_clips.php 14687 2008-06-26 06:52:47Z testyang $
 */
...
function get_user_default($user_id)
{
    ...
    $sql = "SELECT COUNT(*) FROM " .$GLOBALS['ecs']->table('idea').
            " WHERE author = '" .$user_id. "' AND add_time > '" .local_strtotime('-1 months'). "'";
