...
/**
 * SINEMALL 资料分类管理程序语言文件 * $Author: testyang $
 * $Id: articlecat.php 14481 2008-04-18 11:23:01Z testyang $
*/

$_LANG['cat_name'] = '资料分类名称';
$_LANG['type'] = '分类类型';
...
$_LANG['isopen'] = '显示';
$_LANG['isclose'] = '不显示';
$_LANG['add_article'] = '添加资料';

$_LANG['articlecat_edit'] = '资料分类编辑';
$_LANG['articlecat_logo'] = '资料分类标题图';
$_LANG['articlecat_templete'] = '资料分类模板';
$_LANG['cat_article_id'] = '主要资料ID';
$_LANG['cat_user_rank'] = '分类阅读权限';
...
$_LANG['not_emptycat'] = '分类下还有资料，不允许删除非空分类';

/*帮助信息*/
$_LANG['notice_keywords'] ='关键字为选填项，其目的在于方便外部搜索引擎搜索';
$_LANG['notice_isopen'] ='该资料分类是否显示在前台的主导航栏中。';
