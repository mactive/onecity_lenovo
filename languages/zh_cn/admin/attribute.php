<?php
/**
 * SINEMALL 商品类型管理语言文件 * $Author: testyang $
...
$_LANG['label_attr_img'] = '属性图片：';
$_LANG['drop_attr_img'] = '删除图片：';
$_LANG['confirm_drop_attr_img'] = '确认删除：';

$_LANG['label_attr_brief'] = '属性简介：';
$_LANG['label_attr_desc'] = '属性详述：';
