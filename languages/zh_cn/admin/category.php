...
/**
 * SINEMALL 商品分类管理语言文件 * $Author: testyang $
...
/*帮助信息*/
$_LANG['up_catlogo'] = '请上传图片，做为分类的LOGO！';
$_LANG['warn_catlogo'] = '你已经上传过分类logo图片。再次上传时将覆盖原图片！';
$_LANG['drop_cat_logo'] = '删除图标';
$_LANG['confirm_drop_logo'] = '你确认要删除该图标吗？';
$_LANG['drop_cat_logo_success'] = '删除品牌大图成功';
