...
/**
 * OSC PRO 管理中心共用语言文件 * $Author: testyang $
 * $Id: common.php 14481 2008-04-18 11:23:01Z testyang $
*/

$_LANG['app_name'] = '联想广告管理平台';
$_LANG['cp_home'] = '联想广告管理平台 管理中心';
$_LANG['copyright'] = '版权所有 &copy; 1998-2010 联想广告管理平台，并保留所有权利。';
...
/*价格比例*/
$_LANG['market_price_rate'] = '市场价格比例';
$_LANG['shop_price_rate'] = '网上零售价格比例';
$_LANG['salebase_price_rate'] = '销售底价价格比例';
$_LANG['agency_price_rate'] = '批发价格比例';

$_LANG['shop_rate_img'] = '<img src="../themes/default/images/shop_rate.png"/>';
$_LANG['cat_rate_img'] = '<img src="../themes/default/images/cat_rate.png"/>';
$_LANG['brand_rate_img'] = '<img src="../themes/default/images/brand_rate.png"/>';
...
/* 菜单分类部分 */
$_LANG['02_cat_and_goods'] = '城市管理';
$_LANG['03_promotion'] = '其他产品管理';
$_LANG['04_order'] = '订单管理';
$_LANG['05_banner'] = '广告管理';
$_LANG['06_stats'] = '报表统计';
$_LANG['07_content'] = '资料管理';
$_LANG['08_members'] = '用户管理';
...
$_LANG['17_inventory'] = '库存管理';
$_LANG['18_solution_order'] = '配单管理';
$_LANG['19_training'] = '培训管理';
...
$_LANG['article_auto'] = '资料自动发布';
$_LANG['navigator'] = '自定义导航栏';

/* 培训管理*/
$_LANG['01_event_list'] = '培训事件列表';
$_LANG['02_event_add'] = '增加培训事件';
$_LANG['02_course_list'] = '课程列表';
$_LANG['02_course_add'] = '增加课程';
$_LANG['03_course_cat_list'] = '课程分类列表';
$_LANG['03_course_cat_add'] = '添加课程分类';
$_LANG['05_lesson_list'] = '课时列表';
$_LANG['05_lesson_add'] = '增加课时';
$_LANG['06_video_list'] = '视频列表';
$_LANG['06_video_add'] = '添加视频';
$_LANG['07_certificate_list'] = '认证列表';
$_LANG['08_level_list'] = '通用级别列表';
$_LANG['10_teacher_list'] = '讲师列表';
$_LANG['11_student_list'] = '学员列表';
$_LANG['12_message_list'] = '消息列表';
$_LANG['13_rank_list'] = '评价列表';
$_LANG['14_location_list'] = '培训教室';

/* 库存管理 */
$_LANG['01_inventory_list'] = '库存列表';
$_LANG['02_inspect_part_number']	  = '核对入库';
$_LANG['03_batch_inventory']  = '批量操作';
$_LANG['04_out_of_date_inventory'] = '超期库存';
$_LANG['05_inventory_status'] = '库存状态';
$_LANG['06_inventory_log'] = '库存操作记录';
$_LANG['07_inventory_status_accounting'] = '状态库存统计表';


/* 配单管理 */
$_LANG['01_solution_step_list'] = '单项步骤表';
$_LANG['02_solution_list']	  = '解决方案表';
$_LANG['03_congif_order_list']  = '配单库';
$_LANG['04_saler_list'] = '业务员配单库';
$_LANG['05_customer_list'] = '客户配单库';
$_LANG['06_config_order_log'] = '配单行为记录';
...
/* 资料管理 */
$_LANG['02_articlecat_list'] = '资料分类';
$_LANG['articlecat_add'] = '添加资料分类';
$_LANG['03_article_list'] = '资料列表';
$_LANG['04_success_cases'] = '成功案例';
$_LANG['article_add'] = '添加新资料';
$_LANG['shop_article'] = '网店资料';
$_LANG['shop_info'] = '网店信息';
$_LANG['shop_help'] = '网店帮助';
$_LANG['vote_list'] = '在线调查';
$_LANG['success_cases'] = '成功案例';

/* 点子管理 */
$_LANG['06_ideacat_list'] = '点子分类';
$_LANG['ideacat_add'] = '添加点子分类';
$_LANG['05_idea_list'] = '点子列表';
$_LANG['idea_add'] = '添加新点子';

/* 会员管理 */
$_LANG['08_unreply_msg'] = '在线留言';
$_LANG['03_users_list'] = '用户列表';
$_LANG['04_users_add'] = '添加用户';
$_LANG['05_user_rank_list'] = '用户级别';
...
/* 系统设置 */
$_LANG['01_shop_config'] = '网站设置';
$_LANG['01_index_config'] = '首页设置';
