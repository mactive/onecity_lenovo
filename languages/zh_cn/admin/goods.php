...
/**
 * SINEMALL 管理中心起始页语言文件 * $Author: testyang $
...
$_LANG['goods_sn'] = '货号';
$_LANG['last_update'] = '最后更新';
$_LANG['shop_price'] = '网上零售价';
$_LANG['salebase_price'] = '销售底价';
$_LANG['average_price'] = '成本价';
$_LANG['is_on_sale'] = '上架';
$_LANG['miaosha'] = '秒杀';
...
$_LANG['tab_linkgoods'] = '相关商品';
$_LANG['tab_similargoods'] = '相似商品';
$_LANG['tab_groupgoods'] = '配件';
$_LANG['tab_article'] = '关联资料';
...
$_LANG['lab_average_price'] = '平均成本价：';
$_LANG['lab_market_price'] = '市场售价：';
$_LANG['lab_salebase_price'] = '销售底价：';
$_LANG['lab_agency_price'] = '批发代理价：';


$_LANG['lab_market_price_rate'] = '市场价格比例';
$_LANG['lab_shop_price_rate'] = '网上零售价格比例';
$_LANG['lab_salebase_price_rate'] = '销售底价价格比例';
$_LANG['lab_agency_price_rate'] = '批发价格比例';

$_LANG['compute_by_rate'] = '按比例计算';
$_LANG['compute_form_salebase_price_by_rate'] = '按销售底价计算';
$_LANG['compute_form_average_price_by_rate'] = '按成本价计算';
$_LANG['integral_all_price'] = '全部取整';
$_LANG['part_number'] = 'part_number';

$_LANG[''] = '价：';
$_LANG[''] = '价：';
$_LANG['lab_price_rate_level'] = '价格比例：';

$_LANG['price_rate_level'][shop_price_rate] = '商店价格比例';
//去掉分类的价格显示比例
//$_LANG['price_rate_level'][cat_price_rate] = '分类价格比例';
$_LANG['price_rate_level'][brand_price_rate] = '品牌价格比例';
...
$_LANG['lab_goods_status'] = '商品状态：';

$_LANG['cannot_change'] = '系统计算生成';


$_LANG['goods_status_0'] = '现货';
$_LANG['goods_status_1'] = '订货';
$_LANG['goods_status_2'] = '始终有货';
$_LANG['goods_status_3'] = '尾货';
$_LANG['goods_status_4'] = '即将到货';
$_LANG['goods_status_5'] = '正常';
$_LANG['goods_status_6'] = '停产';
$_LANG['goods_status_7'] = '现货';
$_LANG['goods_status_9'] = '现货';
...
$_LANG['notice_goods_number'] = '直接在这里修改库存 会造成和库存系统的数量不统一。';
...
$_LANG['notice_user_price'] = '会员价格为-1时表示会员价格按员工级别折扣率计算。你也可以为每个等级指定一个固定价格';
...
$_LANG['similar_goods'] = '跟该商品相似的商品';
$_LANG['single'] = '单向关联';
$_LANG['double'] = '双向关联';
$_LANG['all_article'] = '可选资料';
$_LANG['goods_article'] = '跟该商品关联的资料';
$_LANG['top_cat'] = '顶级分类';
