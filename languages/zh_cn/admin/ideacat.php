...
/**
 * SINEMALL 点子分类管理程序语言文件 * $Author: testyang $
 * $Id: ideacat.php 14481 2008-04-18 11:23:01Z testyang $
*/

$_LANG['cat_name'] = '点子分类名称';
$_LANG['type'] = '分类类型';
...
$_LANG['ideacat_edit'] = '点子分类编辑';
$_LANG['ideacat_logo'] = '点子分类标题图';
$_LANG['ideacat_templete'] = '点子分类模板';
$_LANG['cat_idea_id'] = '主要点子ID';
...
$_LANG['not_emptycat'] = '分类下还有点子，不允许删除非空分类';

/*帮助信息*/
$_LANG['notice_keywords'] ='关键字为选填项，其目的在于方便外部搜索引擎搜索';
$_LANG['notice_isopen'] ='该点子分类是否显示在前台的主导航栏中。';
