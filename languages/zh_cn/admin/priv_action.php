...
/**
 * SINEMALL 权限名称语言文件 * $Author: testyang $
 * $Id: priv_action.php 14481 2008-04-18 11:23:01Z testyang $
*/
/* 权限管理的一级分组 */
$_LANG['goods'] = '商品管理';
$_LANG['cms_manage'] = '资料管理';
...
$_LANG['topic_manage'] = '产品系列';
$_LANG['virualcard'] = '虚拟卡管理';

//资料管理部分的权限
$_LANG['article_cat'] = '资料分类管理';
$_LANG['article_manage'] = '资料内容管理';
...
$_LANG['inventory_list'] = '库存列表';
$_LANG['inspect_part_number']	  = '核对入库';
$_LANG['batch_inventory']  = '批量操作';
$_LANG['out_of_date_inventory'] = '超期库存';
$_LANG['inventory_status'] = '库存状态';
$_LANG['inventory_log'] = '库存操作记录';
$_LANG['inventory_status_accounting '] = '状态库存统计表';
?>
