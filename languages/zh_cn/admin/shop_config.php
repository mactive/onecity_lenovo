<?php
/**
 * SINEMALL 管理中心网站设置语言文件 * $Author: testyang $
...
$_LANG['cfg_name']['shop_price_rate'] = '网上零售价格比例';
$_LANG['cfg_name']['salebase_price_rate'] = '销售底价价格比例';
$_LANG['cfg_name']['agency_price_rate'] = '批发价格比例';
...
$_LANG['cfg_name']['best_number'] = '推荐推荐数量';
...
$_LANG['cfg_name']['article_number'] = '最新资料显示数量';
$_LANG['cfg_name']['order_number'] = '订单显示数量';
$_LANG['cfg_name']['shop_name'] = '网站名称';
$_LANG['cfg_name']['shop_title'] = '网站标题';
$_LANG['cfg_name']['shop_website'] = '网站网址';
$_LANG['cfg_name']['shop_desc'] = '网站描述';
$_LANG['cfg_name']['shop_keywords'] = '网站关键字';
...
$_LANG['cfg_name']['salesman_notice'] = '销售人员公告';
$_LANG['cfg_name']['shop_notice'] = '网站公告';
...
$_LANG['cfg_name']['shop_logo'] = '网站 Logo';
...
$_LANG['cfg_name']['show_rankprice'] = '是否显示用户分级价格';
...
$_LANG['cfg_name']['article_title_length'] = '资料标题的长度';
...
$_LANG['cfg_name']['related_goods_number'] = '相关商品显示数量';
$_LANG['cfg_name']['visit_stats'] = '站点访问统计';
$_LANG['cfg_name']['help_open'] = '用户帮助是否打开';
$_LANG['cfg_name']['index_news_article_cat'] = '首页新闻资料分类';
$_LANG['cfg_name']['index_cases_article_cat'] = '首页成功案例资料分类';
$_LANG['cfg_name']['index_solutions_article_cat'] = '首页解决方案资料分类';

$_LANG['cfg_desc']['smtp'] = '设置邮件服务器基本参数';
$_LANG['cfg_desc']['market_price_rate'] = '调整价格时将自动根据该比例和平均成本价计算市场价格';
$_LANG['cfg_desc']['shop_price_rate'] = '调整价格时将自动根据该比例和平均成本价计算网上零售价格';
$_LANG['cfg_desc']['salebase_price_rate'] = '调整价格时将自动根据该比例和平均成本价计算销售底价';
$_LANG['cfg_desc']['agency_price_rate'] = '调整价格时将自动根据该比例和平均成本价计算批发代理价格';
...
$_LANG['cfg_desc']['shop_title'] = '网站的标题将显示在浏览器的标题栏';
...
$_LANG['cfg_desc']['salesman_notice'] = '该信息将在销售人员欢迎页面显示';
...
$_LANG['cfg_desc']['shop_notice'] = '以上内容将显示在首页网站公告中,注意控制公告内容长度不要超过公告显示区域大小。';
...
$_LANG['cfg_range']['show_rankprice']['1'] = '显示';
$_LANG['cfg_range']['show_rankprice']['0'] = '不显示';
...
$_LANG['gzip_confirm'] = "GZip 功能需要您的服务器支持 zlib 扩展库。\\n如果您发现开启Gzip后页面出现乱码，可能是您的服务器已经开启了Gzip，您不需要在 SINEMALL 中再次开启。";
