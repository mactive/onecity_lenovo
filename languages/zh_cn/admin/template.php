...
/**
 * SINEMALL 管理中心模板管理语言文件 * $Author: zhuwenyuan $
...
/* 每一个模板文件对应的语言 */
$_LANG['template_files']['article'] = '资料内容模板';
$_LANG['template_files']['article_cat'] = '资料分类模板';
$_LANG['template_files']['customer_center'] = '客服中心';
$_LANG['template_files']['brand'] = '品牌专区';
$_LANG['template_files']['category_list'] = '所有分类页';
$_LANG['template_files']['category'] = '商品分类页模板';
$_LANG['template_files']['category_no_goods'] = '无商品列表的分类页模板';
$_LANG['template_files']['case'] = '成功案例模板';
$_LANG['template_files']['training'] = '培训页面模板';
...
$_LANG['template_files']['mall'] = 'mall首页模板';
$_LANG['template_files']['five'] = '五周年首页模板';
...
$_LANG['template_libs']['help_bar'] ='帮助信息吧';
$_LANG['template_libs']['sub_cate_list'] ='子分类列表区域';
$_LANG['template_libs']['buy_guide'] ='产品导购';
$_LANG['template_libs']['cat_articles'] = '资料列表';
$_LANG['template_libs']['customer_center'] = '客服中心资料列表';
$_LANG['template_libs']['articles'] = '资料列表';
$_LANG['template_libs']['goods_attrlinked'] = '属性关联的商品';
$_LANG['template_libs']['recommend_best'] = '推荐推荐';
$_LANG['template_libs']['quick_link'] = '快速链接';
$_LANG['template_libs']['news_index'] = '首页新闻列表';
$_LANG['template_libs']['ads_fat'] = '宽幅随机广告';
$_LANG['template_libs']['category_tree_fat'] = '宽幅分类广告';
$_LANG['template_libs']['ads_thin'] = '窄幅随机广告';
$_LANG['template_libs']['contact_bar'] = '联系信息';
$_LANG['template_libs']['index_recommend_best'] = '首页推荐推荐';
$_LANG['template_libs']['recommend_promotion'] = '促销商品';
$_LANG['template_libs']['recommend_hot_index'] = '首页热卖商品';
$_LANG['template_libs']['recommend_hot'] = '热卖商品';
$_LANG['template_libs']['recommend_new'] = '新品上架';
$_LANG['template_libs']['recommend_ajax'] = 'Ajax效果';
...
$_LANG['template_libs']['goods_article'] = '相关资料';
...
$_LANG['template_libs']['new_articles'] = '最新资料';
...
$_LANG['template_libs']['article_category_tree'] = '资料分类树';
