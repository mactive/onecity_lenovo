...
/**
 * SINEMALL 购物流程相关语言 * $Author: testyang $
...
$_LANG['flow_no_insure'] = '您必须在保价和不保价之间做出选择。';
...
$_LANG['depends_notice'] = '视情况而定';
$_LANG['insure_notice'] = "不论您选择哪家物流，您必须在保价和不保价中做出选择，保价费由买家承担。";
$_LANG['yes_insure'] = '保价';
$_LANG['no_insure'] = '不保价';
$_LANG['daofu_title'] = '运费到付送货上门';
$_LANG['daofu_notice'] = '购物不足5000元，或购买特价商品，由买家承担运费，送货上门，运费到付。如果您选择运费到付送货上门，请在下方选项中做出选择';
$_LANG['shipping_fee_notice'] = '* 免费货运 请选择你喜欢的款第公司。';
...
$_LANG['remember_order_number'] = '感谢您在网购物！您的订单已提交成功，请记住您的订单号';
