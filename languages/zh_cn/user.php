...
/**
 * SINEMALL 用户中心语言项 * $Author: testyang $
...
$_LANG['msg_un_length'] = '用户名最长不得超过20个汉字';
...
$_LANG['agreement'] = "看过并接受《<a href=\"article.php?id=6\" style=\"color:blue\" target=\"_blank\">用户协议</a>》";
...
/* 业务员配单*/
$_LANG['my_solution_list'] = '我的客户配单库';
$_LANG['add_solution'] = '增加客户配单';
$_LANG['solution_name'] = '配单名';
$_LANG['solution_id'] = '配单号';
$_LANG['solution_amount'] = '配单总金额';
$_LANG['custom_info'] = '客户信息';
$_LANG['order_note'] = '备注';
$_LANG['move_to_trash'] = '放入回收站';
$_LANG['delete'] = '删除';
$_LANG[''] = '';
$_LANG[''] = '';
$_LANG[''] = '';
...
$_LANG['passport_js']['mobile_phone_shorter'] = '- 手机号不能少于 13 个数字。';
...
$_LANG['passport_js']['real_name_invalid'] = '- 真实姓名不能少于两个字';
...
$_LANG['passport_js']['msg_un_length'] = '* 用户名最长不得超过20个汉字';
...
$_LANG['passport_js']['msg_email_no_support'] = '* 该邮箱可能收不到认证邮件,请换一个';
...
$_LANG['resend_hash_mail'] = '没收到认证邮件？点此重新发送';
