...
/**
 * SINEMALL 资料分類管理程序語言文件   * $Author: dolphin $
 * $Id: articlecat.php 14547 2008-05-04 03:09:19Z dolphin $
*/

$_LANG['cat_name'] = '资料分類名稱';
$_LANG['type'] = '分類類型';
...
$_LANG['notice_isopen'] ='該资料分類是否顯示在前台的主導航欄中。';
