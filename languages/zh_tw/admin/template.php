...
/**
 * SINEMALL 管理中心模板管理語言文件   * $Author: dolphin $
 * $Id: template.php 14547 2008-05-04 03:09:19Z dolphin $
*/
...
/* 每一個模板文件對應的語言 */
$_LANG['template_files']['article'] = '资料內容模板';
$_LANG['template_files']['article_cat'] = '资料分類模板';
...
$_LANG['template_libs']['goods_article'] = '相關资料';
...
$_LANG['template_libs']['article_category_tree'] = '资料分類樹';
