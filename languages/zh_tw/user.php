...
/**
 * SINEMALL 用戶中心語言項   * $Author: dolphin $
 * $Id: user.php 14709 2008-07-07 08:45:51Z dolphin $
*/
...
$_LANG['passport_js']['username_shorter'] = '- 用戶名長度不能少於 2 個字符。';
...
$_LANG['passport_js']['real_name_invalid'] = '- 家庭電話不是一個有效號碼';
