...
if (!$smarty->is_cached('mall.dwt', $cache_id))
{
	...
	//$smarty->assign('top_cates',	   get_top_category());//all top cate
	$smarty->assign('goods_by_cate',   get_recommend_goods_cate_new());//all cate
    ...
    $smarty->assign('new_articles',    index_get_new_articles());   // 最新资料
	...
	//print_r(get_articlecat_subcat($cc));
