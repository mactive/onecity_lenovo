...
if (!$smarty->is_cached('stars.dwt', $cache_id))
{
    assign_template();

    $position = assign_ur_here();
    $smarty->assign('page_title',      $_LANG['five_year']."－五星上将评选");     // 页面标题
	...
	*/
	...
	$miaosha_people = get_article_info(169);
...
$smarty->display('stars.dwt', $cache_id);
