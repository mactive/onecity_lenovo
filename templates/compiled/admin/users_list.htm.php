...
<!-- $Id: users_list.htm 14216 2008-03-10 02:27:21Z testyang $ -->
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('real_name'); "><?php echo $this->_var['lang']['real_name']; ?></a><?php echo $this->_var['sort_real_name']; ?></th>
    <th><a href="javascript:listTable.sort('user_rank'); "><?php echo $this->_var['lang']['user_rank']; ?></a><?php echo $this->_var['sort_user_rank']; ?></th>
    <th><a href="javascript:listTable.sort('last_login'); "><?php echo $this->_var['lang']['last_login']; ?></a><?php echo $this->_var['sort_last_login']; ?></th>
...
?>
  <tr>
    <td><input type="checkbox" name="checkboxes[]" value="<?php echo $this->_var['user']['user_id']; ?>" /><?php echo $this->_var['user']['user_id']; ?></td>
    ...
    <td align="center"><?php echo $this->_var['user']['real_name']; ?></td>
    <td align="center"><?php echo $this->_var['user']['user_rank']; ?></td>
