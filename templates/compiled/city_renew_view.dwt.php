...
<script type="text/javascript">   
	function confrim_delete(ad_ID){
		...
		if(<?php echo $this->_var['sm_session']['user_rank']; ?>  && con == true){
	...
	<div id="container">
		...
		<div id="page-middle">
			...
			<?php if ($this->_var['act_step'] == "city_ad_list"): ?>
				...
				<?php echo $this->fetch('library/city_renew_ad_list.lbi'); ?>
			...
			<?php endif; ?>
				...
				<?php if ($this->_var['act_step'] == "edit_ad"): ?>
					...
					<?php echo $this->fetch('library/renew_edit_ad.lbi'); ?>
...
?>
					<div class="city_info radius_5px"  id="area_<?php echo $this->_var['k']; ?>">
