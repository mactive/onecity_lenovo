	...
	<div id="container">
		...
		<div id="page-middle">
				...
				<?php if ($this->_var['act_step'] == "upload_file"): ?>
					<div class="yellow_notice font14px" style="width:600px;"><?php echo $this->_var['upload_message']; ?></div>
...
?>
				...
				<?php if ($this->_var['act_step'] == "upload_file"): ?>
				<div class="table_div" <?php if ($this->_var['act_step'] == "upload_file"): ?>style="width:1800px;margin-top:100px;"<?php endif; ?>>
				<table width="100%" id="lesson-table" class="table_border table_standard" border="1">
					<tr>
