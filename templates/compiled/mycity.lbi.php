...
<ul class="mycity_ul">
	<li><a href="city_project.php?act=base_info&project_id=9" style="background:url(<?php echo $this->_var['img_path']; ?>red_arrow.png) no-repeat 10px center;">基础信息修改</a></li>
	<li><a href="city_project.php?act=expense_material" style="background:url(<?php echo $this->_var['img_path']; ?>red_arrow.png) no-repeat 10px center;">报销资料状态</a></li>	
</ul>
