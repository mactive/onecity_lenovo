...
<?php $_from = $this->_var['publish_fee_title']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'item_0_00026700_1328795357');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['item_0_00026700_1328795357']):
?>
<div class="city_info radius_5px">
	<div class="f_left left_title left_radius_5px" style="width:400px;"><?php echo $this->_var['item_0_00026700_1328795357']; ?></div>
