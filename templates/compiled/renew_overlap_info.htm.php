...
<div style="border:5px solid #6AB30F;float:left;padding:10px;background:#D2FC89;">	
	...
	<?php endif; ?>
<?php $_from = $this->_var['renew_fee_note']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'item_0_59605000_1333976103');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['item_0_59605000_1333976103']):
?>
<div class="city_info radius_5px">
	<div class="f_left left_title left_radius_5px" style="width:400px;"><?php echo $this->_var['item_0_59605000_1333976103']; ?></div>
